	...
	---------------------------------------------------------------------- */
            ...
            sortOrder = docElem.compareDocumentPosition ? function (a, b) {
                ...
                if (a === b) {
                    ...
                    return a === doc ? -1 : b === doc ? 1 : aup ? -1 : bup ? 1
        ...
        Sizzle.attr = function (elem, name) {
            ...
            return val === undefined ? support.attributes || !documentIsHTML
                ? elem.getAttribute(name) : (val = elem.getAttributeNode(name))
                ...
                "ATTR": function (name, operator, check) {
                    return function (elem) {
                        ...
                        === "!=" ? result !== check : operator === "^=" ? check
                            && result.indexOf(check) === 0 : operator === "*="
                            ? check && result.indexOf(check) > -1 : operator
                            === "$=" ? check && result.slice(-check.length)
                ...
                matchers = [function (elem, context, xml) {
                    return (!leadingRelative && (xml || context
                        ...
                        (checkContext = context).nodeType ? matchContext(elem,
                            context, xml) : matchAnyContext(elem, context,
                            xml));
                }];
            ...
            addHandle(booleans, function (elem, name, isXML) {
                ...
                if (!isXML) {
                    return (val = elem.getAttributeNode(name)) && val.specified
                        ? val.value : elem[name] === true ? name.toLowerCase()
                            : null;
                }
            });
        }
 ...
 */
    ...
    jQuery.support = (function (support) {
        ...
        support.html5Clone = document.createElement("nav").cloneNode(
            ...
            || !ruseDefault.test(name) ? function (elem, name, isXML) {
                var fn = jQuery.expr.attrHandle[name],
                    ret = isXML ? undefined : /* jshint eqeqeq: false */
                        ...
                        getter(elem, name, isXML) ? name.toLowerCase() : null;
                jQuery.expr.attrHandle[name] = fn;
                return ret;
            } : function (elem, name, isXML) {
                return isXML ? undefined : elem[jQuery.camelCase("default-"
                        ...
                        for (i = 0; i < delegateCount; i++) {
                            ...
                            if (matches[sel] === undefined) {
                                matches[sel] = handleObj.needsContext ? jQuery(
                                    sel, this).index(cur) >= 0 : jQuery.find(
    ...
    jQuery.fn.extend({
        ...
        html: function (value) {
            return jQuery.access(this, function (value) {
                ...
                if (value === undefined) {
                    return elem.nodeType === 1 ? elem.innerHTML.replace(
                        rinlinejQuery, "") : undefined;
                }
...
// Manipulating tables requires a tbody
    function manipulationTarget(elem, content) {
        ...
        jQuery.nodeName(content.nodeType === 1 ? content : content.firstChild,
            "tr") ? elem.getElementsByTagName("tbody")[0] ||
            ...
            get: function (elem, computed, extra) {
                if (computed) {
                    ...
                    return elem.offsetWidth === 0 && rdisplayswap.test(
                        jQuery.css(elem, "display")) ? jQuery.swap(elem,
                        cssShow, function () {
                ...
                jQuery.cssHooks[prop] = {
                    get: function (elem, computed) {
                        if (computed) {
                            ...
                            return rnumnonpx.test(computed) ? jQuery(
                                elem).position()[prop] + "px" : computed;
                        }
                    }
                };
            });
    ...
    jQuery.fn.extend({
        ...
        serializeArray: function () {
            ...
            .map(function (i, elem) {
                ...
                return val == null ? null : jQuery.isArray(val) ? jQuery.map(
                    val, function (val) {
                        return {
                            name: elem.name,
