    ...
    RemoteImage.prototype = {
        ...
        initEvents: function () {
            ...
            domUtils.on($G("lock"), 'change', function () {
                var proportion = parseInt($G("width").value) / parseInt(
                    $G("height").value);
        ...
        updateLocker: function () {
            var width = $G('width').value,
                ...
                locker = $G('lock');
            if (width && height && width == parseInt(width) && height
                == parseInt(height)) {
        ...
        setImage: function (img) {
            ...
            var wordImgFlag = img.getAttribute("word_img"),
                src = wordImgFlag ? wordImgFlag.replace("&amp;", "&")
                    : (img.getAttribute('_src') || img.getAttribute("src",
                        2).replace("&amp;", "&")),
    ...
    OnlineImage.prototype = {
        ...
        getImageData: function () {
            ...
            if (!_this.listEnd && !this.isLoadingData) {
                ...
                var url = editor.getActionUrl(
                    editor.getOpt('imageManagerActionName')),
        ...
        getImageData: function () {
            var _this = this,
                ...
                url = "http://image.baidu.com/i?ct=201326592&cl=2&lm=-1&st=-1&tn=baiduimagejson&istype=2&rn=32&fm=index&pv=&word="
                    + _this.encodeToGb2312(key) + type + "&keeporiginname="
