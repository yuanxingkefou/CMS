            ...
            if (hasEffect) {
                ...
                Effect.HighchartsTransition = Class.create(Effect.Base, {
                    initialize: function (element, attr, to, options) {
                        ...
                        this.key = attr;
                        from = element.attr ? element.attr(attr) : $(
                    ...
                    update: function (position) {
                        ...
                        if (paths) {
                            position = pathAnim.step(paths[0], paths[1],
                                position, this.toD);
                        }
        ...
        animate: function (el, params, options) {
            ...
            if (hasEffect) {
                for (key in params) {
                    ...
                    fx = new Effect.HighchartsTransition($(el), key,
                        params[key], options);
                }
            } else {
            ...
            if (!object._highcharts_extended) {
                Object.extend(object, {
                    ...
                    _highcharts_stop_observing: function (name, fn) {
                        if (name) {
                            if (fn) {
                                this._highchart_events[name] = [this._highchart_events[name]].compact().flatten().without(
                                    fn);
                            } else {
