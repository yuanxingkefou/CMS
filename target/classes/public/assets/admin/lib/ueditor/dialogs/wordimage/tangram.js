...
baidu.browser.opera = /opera(\/| )(\d+(\.\d+)?)(.+?(version\/(\d+(\.\d+)?)))?/i.test(
    navigator.userAgent) ? +(RegExp["\x246"] || RegExp["\x242"]) : undefined;
...
baidu.swf.createHTML = function (options) {
    ...
    var vars = options['vars'],
        objProperties = ['classid', 'codebase', 'id', 'width', 'height',
            'align'];
...
baidu.swf.getMovie = function (name) {
    ...
    return baidu.browser.ie == 9 ? movie && movie.length
...
baidu.flash._Base = (function () {
    ...
    function _checkReady(target) {
        if (typeof target !== 'undefined' && typeof target.flashInit
            !== 'undefined' && target.flashInit()) {
            return true;
        } else {
            return false;
        }
    ...
    return function (options, callBack) {
        var me = this,
            autoRender = (typeof options.autoRender !== 'undefined'
...
baidu.flash.fileUploader = baidu.flash.fileUploader || function (options) {
    ...
    me.upload = function (url, fieldName, postData, index) {
        ...
        if (typeof url !== 'string' || typeof fieldName
            !== 'string') {
            return null;
        }
...
baidu.sio.callByServer = /**@function*/function (url, callback, opt_options) {
    ...
    if (baidu.lang.isFunction(callback)) {
        callbackName = prefix + Math.floor(Math.random() * 2147483648).toString(
            36);
